...
module Marlowe.Plutus.Extended.Metadata.Types where
...
-- | Metadata for Marlowe Extended contracts
-- Uses regular Map instead of OMap for simplicity
data MetaData = MetaData
  { contractType :: ContractType
  , contractName :: String
  , contractShortDescription :: String
  , contractLongDescription :: String
  , roleDescriptions :: OMap TokenName String
  ...
  , choiceInfo :: OMap ChoiceName ChoiceInfo
  }
  deriving stock (Show, Eq, Generic)
