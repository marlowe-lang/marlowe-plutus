...
module Language.Marlowe.Runtime.Query.Database.PostgreSQL.GetRoleCurrencies (
  getRoleCurrencies,
)
where
...
import Language.Marlowe.Runtime.Query.Database.PostgreSQL.Schema (equals, leftJoinOn, naturalJoin, unnestParams, withCTEs)
import qualified Language.Marlowe.Runtime.Query.Database.PostgreSQL.Schema as Schema
import Language.Marlowe.Runtime.Query.Database.PostgreSQL.GetContractState (decodeContractId)
import Language.Marlowe.Runtime.Query.Database.PostgreSQL.GetHeaders (parenthesize)
