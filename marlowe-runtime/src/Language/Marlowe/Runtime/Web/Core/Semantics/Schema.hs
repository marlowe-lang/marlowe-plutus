...
module Language.Marlowe.Runtime.Web.Core.Semantics.Schema where
    ...
    pure $
      NamedSchema (Just "ChoiceId") $
        mempty
          ...
          & properties .~ HashMap.fromList [choice_name, choice_owner]
  ...
  declareNamedSchema _ = do
    ...
    let rolePartySchema =
          mempty
            ...
            & properties .~ HashMap.fromList [role_token]
          where
        ...
        addressPartySchema =
          mempty
            ...
            & properties .~ HashMap.fromList [address]
          where
  ...
  declareNamedSchema _ = do
    ...
    let accountPayeeSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [account]
          where
        ...
        partyPayeeSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [party]
          where
    ...
    pure $
      NamedSchema (Just "Token") $
        mempty
          ...
          & properties .~ HashMap.fromList [currency_symbol, token_name]
    ...
    let timeIntervalSchema =
        ...
        availableMoneySchema =
          mempty
            ...
            & properties .~ HashMap.fromList [amount_of_token, in_account]
          where
        ...
        negValueSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [negate_]
          where
        ...
        addValueSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [val1, val2]
          where
        ...
        choiceValueSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [value_of_choice]
          where
        ...
        useValueSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [use_value]
          where
        ...
        condSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [if_, then_, else_]
          where
    ...
    let constantSchema = mempty & type_ ?~ OpenApiBoolean
        andObsSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [both, and_]
          where
        ...
        orObsSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [either_, or_]
          where
        ...
        choseSomethingSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [chose_something_for]
          where
        ...
        valueGESchema =
          mempty
            ...
            & properties .~ HashMap.fromList [value, ge_than]
          where
        ...
        valueGTSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [value, gt]
          where
            value = ("value", valueSchema)
            gt = ("gt", valueSchema)
        valueLESchema =
          mempty
            ...
            & properties .~ HashMap.fromList [value, le_than]
          where
            value = ("value", valueSchema)
        ...
        valueLTSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [value, lt]
          where
            value = ("value", valueSchema)
            lt = ("lt", valueSchema)
        valueEQSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [value, equal_to]
          where
            value = ("value", valueSchema)
    ...
    pure $
      NamedSchema (Just "Bound") $
        mempty
          ...
          & properties .~ HashMap.fromList [from, to]
  ...
  declareNamedSchema _ = do
    ...
    let depositSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [party, deposits, of_token, into_account]
          where
            party = ("party", partySchema)
        ...
        choiceSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [for_choice, choose_between]
          where
        ...
        notifySchema =
          mempty
            ...
            & properties .~ HashMap.fromList [notify_if]
          where
  ...
  declareNamedSchema _ = do
    ...
    let caseSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [case_, then_]
          where
        ...
        merkleizedCaseSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [case_, merkleized_then]
          where
            case_ = ("case", actionSchema)
    ...
    let closeSchema =
        ...
        paySchema =
          mempty
            ...
            & properties .~ HashMap.fromList [from_account, to, token, pay, then_]
          where
        ...
        whenSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [when, timeout, timeout_continuation]
          where
        ...
        letSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [let_, be, then_]
          where
        ...
        assertSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [assert, then_]
          where
    ...
    pure $
      NamedSchema (Just "MarloweState") $
        mempty
          ...
          & properties .~ HashMap.fromList [accounts, choices, boundValues, minTime]
      ...
      pure $
        NamedSchema (Just "Payment") $
          mempty
            ...
            & properties .~ HashMap.fromList [accountIdSchema, payeeSchema, tokenSchema, amountSchema]
      ...
      pure $
        NamedSchema (Just "Transaction") $
          mempty
            ...
            & properties .~ HashMap.fromList [stateSchema, contractSchema, inputSchema, outputSchema]
    ...
    do
      ...
      let intervalSchema' =
            mempty
              ...
              & properties .~ HashMap.fromList [lower, upper]
            where
      ...
      pure $
        NamedSchema (Just "TransactionInput") $
          mempty
            ...
            & properties .~ HashMap.fromList [intervalSchema, inputsSchema]
            & type_ ?~ OpenApiObject
    ...
    do
      ...
      let noErrorSchema =
            mempty
              ...
              & properties .~ HashMap.fromList [warningsSchema, paymentsSchema, stateSchema, contractSchema]
          errorSchema =
            mempty
              & type_ ?~ OpenApiObject
              & description ?~ "Marlowe transaction error."
              & required .~ fmap fst [message]
              & properties .~ HashMap.fromList [message]
            where
      ...
      let ambiguousIntervalSchema =
          ...
          intervalErrorSchema =
            mempty
              ...
              & properties .~ HashMap.fromList [message, interval]
            where
      ...
      let from = ("from", integerSchema)
          ...
          invalidIntervalSchema =
            mempty
              ...
              & properties .~ HashMap.fromList [invalid]
            where
              invalid =
                ( "invalidInterval"
                , Inline $
          ...
          intervalInPastSchema =
            mempty
              ...
              & properties .~ HashMap.fromList [past]
            where
              past =
                ( "intervalInPastError"
                , Inline $
                    mempty
                      ...
                      & properties .~ HashMap.fromList [minTime, from, to]
                )
      pure $
    ...
    do
      ...
      let nonPositiveDepositSchema =
            mempty
              ...
              & properties .~ HashMap.fromList [party, amount, tok, accId]
            where
              party = ("party", partySchema)
          ...
          nonPositivePaySchema =
            mempty
              ...
              & properties .~ HashMap.fromList [accId, amount, tok, payee]
            where
          ...
          partialPaySchema =
            mempty
              ...
              & properties .~ HashMap.fromList [accId, expected, tok, payee, paid]
            where
              accId = ("account", accountIdSchema)
          ...
          shadowingSchema =
            mempty
              ...
              & properties .~ HashMap.fromList [valId, oldVal, newVal]
            where
      ...
      pure $
        NamedSchema (Just "Plutus.Address") $
          mempty
            ...
            & properties .~ HashMap.fromList [addressCredentialSchema, stakingCredentialSchema]
    ...
    do
      ...
      let pubKeyCredentialSchema =
            mempty
              ...
              & properties .~ HashMap.fromList [item]
            where
    ...
    let timeIntervalSchema =
        ...
        refSchema =
          mempty
            ...
            & properties .~ HashMap.fromList [ref]
          where
            ref = ("ref", labelSchema)
    pure $
