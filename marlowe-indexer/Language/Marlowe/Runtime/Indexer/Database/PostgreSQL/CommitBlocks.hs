...
import Language.Marlowe.Runtime.Indexer.Party (ContractTxOutParty (..), commitParties)
...
marloweBlockToTxRows MarloweBlock{..} = flip foldMap9 transactions \case
  CreateTransaction _ ->
    ([], [], [], [], [], [], [], [], [])
  ApplyInputsTransaction _ ->
    ([], [], [], [], [], [], [], [], [])
  WithdrawTransaction _ ->
    ([], [], [], [], [], [], [], [], [])
  InvalidCreateTransaction _ ->
    ([], [], [], [], [], [], [], [], [])
  InvalidApplyInputsTransaction _ _ _ ->
    ([], [], [], [], [], [], [], [], [])
