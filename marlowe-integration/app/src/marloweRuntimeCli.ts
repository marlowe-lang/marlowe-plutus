...
export function runInit(
  ...
  const tmpDir = fs.mkdtempSync('marlowe-runtime-client-test-');
...
// 
// function getMarloweRuntimeClient(repoRoot: string): string {
//   if (process.env.MARLOWE_RUNTIME_CLIENT) {
//     return process.env.MARLOWE_RUNTIME_CLIENT;
//   }
//   return `cabal run -v0 --project-file ${repoRoot}/cabal.project marlowe-runtime-client --`;
// }
// 
// 
// export function execMarloweRuntimeClient(repoRoot: string, args: CliArgs): string {
//   const marloweCli = getMarloweRuntimeClient(repoRoot);
