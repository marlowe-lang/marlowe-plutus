...
import Spec.Integer.Arbitrary (arbitraryInteger, arbitraryPositiveInteger, arbitraryNonnegativeInteger)
...
import Spec.PlutusTx.Arbitrary (arbitraryAnyCurrencySymbol, arbitraryFibonacci, shrinkBuiltinByteString, arbitraryNonAdaCurrencySymbol)
