...
import Spec.Marlowe.Transactions
  ( PayoutTransaction (..)
...
import Spec.PlutusTx.PlutusTransaction
  ( PlutusTransaction (..)
  , datum
  , infoData
  , infoFee
...
import Spec.Integer.Arbitrary (arbitraryPositiveInteger)
...
import qualified Spec.Marlowe.Transactions as Transactions
import Spec.PlutusTx.Arbitrary (arbitraryAnyCurrencySymbol, arbitraryNonAdaCurrencySymbol)
import Spec.PlutusTx.Lens ((<><~))
