...
import Language.Marlowe.Plutus.Merkle (merkleizedCase)
...
partyGen =
  oneof
    [ return $ mkRoleUtf8 "alice"
    , return $ mkRoleUtf8 "bob"
    , return $ unsafeMkPartyAddressBech32 "addr_test1vrssw4edcts00kk6lp7p5n64666m23tpprqaarmdwkaq69gfvqnpz"
    ]
...
valueIdGen =
  oneof
    [ return $ ValueId "alpha"
    , return $ ValueId "beta"
    ]

-- | Shrink a generated value.
shrinkValueId :: ValueId -> [ValueId]
shrinkValueId (ValueId "beta") = [ValueId "alpha"]
shrinkValueId (ValueId "alpha") = []
shrinkValueId _ = []
...
alicePk :: Party
alicePk = unsafeMkPartyAddressBech32 "addr_test1vrssw4edcts00kk6lp7p5n64666m23tpprqaarmdwkaq69gfvqnpz"
