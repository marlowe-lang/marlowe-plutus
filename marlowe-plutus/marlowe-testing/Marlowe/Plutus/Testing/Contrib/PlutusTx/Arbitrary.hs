...
module Marlowe.Plutus.Testing.Contrib.PlutusTx.Arbitrary (
...
import Marlowe.Plutus.Testing.Contrib.Integer.Arbitrary (arbitraryPositiveInteger, arbitraryInteger)
