...
module Marlowe.Plutus.Testing.Contrib.PlutusTx.Debugging.Trace where
...
#else
traceVerbose _ concise = trace concise
#endif
...
#else
traceErrorVerbose _ concise = traceError concise
#endif
...
#else
traceIfFalseVerbose _ concise = traceIfFalse concise
#endif
