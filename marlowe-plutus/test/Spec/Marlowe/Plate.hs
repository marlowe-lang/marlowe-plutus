...
import qualified Language.Marlowe.Plutus.Plate as P
...
extractPartiesTest = do
  let ada = V1.Token PV2.adaSymbol PV2.adaToken
      alice = V1.mkRoleByteString "alice"
      bob = V1.mkRoleByteString "bob"
      hash = "hash"
