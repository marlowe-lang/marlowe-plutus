...
module Language.Marlowe.Plutus.Next.Applicables (
  ApplicableInputs (..),
  emptyApplicables,
  filterByParties,
  mkApplicables,
...
import Language.Marlowe.Plutus.Semantics (evalObservation, evalValue)
...
import Language.Marlowe.Plutus.Next.Applicables.CanChoose (CanChoose (CanChoose, choiceId), difference)
...
import Language.Marlowe.Plutus.Next.Indexed (CaseIndex, Indexed (..), caseIndexed, sameIndexedValue)
