...
module Language.Marlowe.Plutus.Next.Applicables.CanChoose (
  CanChoose (..),
...
import GHC.Generics
import qualified Language.Marlowe.Plutus.Next.Applicables.Bound as Bound
...
import Language.Marlowe.Plutus.Semantics.Types (Bound (..), ChoiceId)
import Prelude
