...
import Marlowe.Plutus.Next.Applicables (ApplicableInputs, mkApplicables)
import qualified Marlowe.Plutus.Next.Applicables as Applicables
import Marlowe.Plutus.Next.CanReduce (CanReduce, tryReduce)
import Marlowe.Plutus.Semantics (fixInterval)
